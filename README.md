...
- **⚡ Real-time on a single GPU.** A 22B interactive audio-visual autoregressive model capable of streaming generation and sub-second interaction, with a record-breaking frame rate of **up to 48 FPS** on a single H100. Generation cost drops well **below \$0.001 per second** — and keeps falling.
